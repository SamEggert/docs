...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Inicio rápido" description="Pon en línea tu primer sitio de documentación en minutos con nuestra guía paso a paso" href="/es/quickstart" />
      ...
      <HeroCard filename="editor" title="Editor web" description="Haz actualizaciones rápidas y gestiona contenido con nuestro editor basado en el navegador" href="/es/editor" />

      <HeroCard filename="components" title="Components" description="Crea documentación completa e interactiva con nuestros components listos para usar" href="/es/text" />
    </div>
  </div>
</div>
