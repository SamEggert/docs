...
Para empezar a crear páginas para tus WebSockets, asegúrate de tener un documento de esquema de AsyncAPI válido en formato JSON o YAML que cumpla con la [especificación de AsyncAPI](https://www.asyncapi.com/docs/reference/specification/v3.0.0). Tu esquema debe ajustarse a AsyncAPI 3.0 o superior.
...
<div id="auto-populate-websockets-pages">
  ## Autocompletar páginas de websockets
</div>
...
Si quieres más control sobre cómo ordenas tus canales o si solo necesitas referirte a un canal específico, puedes crear un archivo MDX con el campo `asyncapi` en el frontmatter.
