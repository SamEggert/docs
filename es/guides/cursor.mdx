...
Convierte Cursor en un experto en documentación que conozca tus components, tu guía de estilo y tus mejores prácticas.
...
Recomendamos crear reglas de proyecto para tu documentación para que todos los colaboradores tengan acceso a las mismas reglas.

Crea archivos de reglas en el directorio `.cursor/rules` de tu repositorio de documentación. Consulta la [documentación de reglas de Cursor](https://docs.cursor.com/context/rules) para ver las instrucciones completas de configuración.

<div id="example-project-rule">
  ## Regla de proyecto de ejemplo
</div>

Esta regla proporciona a Cursor el contexto para formatear correctamente los components de Mintlify y seguir las mejores prácticas de redacción técnica.
...
* **Patrones de componentes**: Agrega components específicos del proyecto o modifica los ejemplos existentes.
...
#### Sugerencia - Mejores prácticas y consejos profesionales
...
<Frame>
<img src="/images/dashboard.png" alt="Dashboard principal mostrando resumen de analíticas" />
</Frame>

<Frame caption="El dashboard de analíticas proporciona información en tiempo real">
<img src="/images/analytics.png" alt="Dashboard de analíticas con gráficos" />
</Frame>
...
<Update label="Versión 2.1.0" description="Lanzada el 15 de marzo de 2024">
...
- Incluye información de limitación de velocidad con límites específicos
