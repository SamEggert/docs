...
Para hacer que una imagen sea un enlace clicable, envuelve la imagen en una etiqueta de enlace y agrega la propiedad `noZoom`:
...
<Note>
  Las imágenes dentro de etiquetas de anclaje muestran automáticamente el cursor de puntero para indicar que son clicables.
</Note>

<div id="light-and-dark-mode-images">
  #### Imágenes para los modos light y oscuro
</div>

Para mostrar imágenes distintas en temas light y oscuro, usa clases de Tailwind CSS:
...
<div id="youtube-embeds">
  ### Contenidos incrustados de YouTube
</div>
...
Para reproducir un video de forma automática, usa:
