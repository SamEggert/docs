...
El componente `<ResponseField>` está diseñado para definir los valores devueltos por una API. Muchas documentaciones también usan `<ResponseField>` en páginas cuando necesitas enumerar los tipos de algo.
