---
title: "Iconos"
description: "Usa icon de bibliotecas de icon populares"
---

import IconsRequired from "/snippets/es/icons-required.mdx";

Usa icon de Font Awesome, Lucide, SVG, URL externas o archivos de tu proyecto para mejorar tu documentación.
