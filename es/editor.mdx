...
* **Integración de components**: Agrega callouts, bloques de código y otros components con comandos de barra (/).
...
<Steps>
  ...
  <Step title="Publica tus cambios">
    Si estás trabajando en tu rama de implementación, publica tus cambios directamente desde el editor visual. En otros branches, crearás un pull request para revisión antes de publicar.
  </Step>
</Steps>
...
Usa el conmutador de modos en la barra de herramientas del editor para cambiar de modo.
...
El modo visual ofrece una experiencia WYSIWYG en la que los cambios que realices en el editor reflejan cómo se verá tu documentación publicada. Este modo es ideal cuando necesitas ver en tiempo real cómo se verán tus cambios.
...
El modo Markdown te da acceso directo al código `MDX` subyacente de tu documentación. Es ideal cuando necesitas un control preciso de las propiedades de los componentes o cuando prefieres escribir con la sintaxis de Markdown.
...
Usa el explorador de archivos de la barra lateral para recorrer tu documentación. Haz clic en cualquier archivo para abrirlo en el editor.

Presiona <kbd>Command</kbd> + <kbd>P</kbd> en macOS o <kbd>Ctrl</kbd> + <kbd>P</kbd> en Windows para buscar archivos por name.
...
Para cambiar el nombre de una página, haz clic en el icon de menú kebab del archivo cuyo nombre deseas cambiar. Selecciona **Renombrar** en el menú desplegable.
...
Para eliminar una página, haz clic en el icon del menú kebab del archivo que quieres eliminar. Selecciona **Delete** en el menú desplegable.
...
Edita tu archivo `docs.json` para agregar páginas nuevas y eliminar las páginas que borraste de la navegación de tu sitio. Consulta [Navegación](/es/organize/navigation) para obtener más información sobre cómo organizar las páginas.

**Ejemplo: agregar una página de Themes al grupo Profile**

En este ejemplo, creaste una página nueva titulada Themes y quieres agregarla al grupo Profile en tu documentación. Agrega la ruta de la nueva página al arreglo `pages` del grupo `Profile` en tu archivo `docs.json` para que aparezca en la navegación de tu sitio.
...
En el modo visual, presiona <kbd>/</kbd> para abrir el menú de components. Agrega bloques de contenido, avisos, bloques de código y otros components para personalizar tu documentación.

<Frame>
  <img src="/images/editor/component-menu-light.png" alt="El menú de components desplegado resaltado en el editor visual de Mintlify" className="block dark:hidden" />

  <img src="/images/editor/component-menu-dark.png" alt="El menú de components desplegado resaltado en el editor visual de Mintlify" className="hidden dark:block" />
</Frame>

En el modo Markdown, editas directamente el `MDX` de tus páginas. Esto puede ser útil cuando necesitas:

* Establecer propiedades específicas de components
* Trabajar con components anidados complejos
* Copiar y pegar contenido `MDX` de otras fuentes

Consulta [Formato de texto](/es/create/text) y [Formato de código](/es/create/code) para obtener más información sobre cómo escribir con la sintaxis de Markdown.

<div id="publish-your-changes">
  ## Publica tus cambios
</div>

La branch en la que trabajes determina cómo el editor publica tus cambios:

* **Rama de implementación**: Al publicar, tu sitio en producción se actualiza de inmediato.
* **Otras ramas**: Al publicar, se crea un pull request para que puedas revisar los cambios antes de implementarlos en producción.

<Frame>
  <img src="/images/editor/publish-flow-light.png" alt="Botón Publicar resaltado en el editor visual de Mintlify" className="block dark:hidden" />

  <img src="/images/editor/publish-flow-dark.png" alt="Botón Publicar resaltado en el editor visual de Mintlify" className="hidden dark:block" />
</Frame>
...
Los pull requests te permiten proponer cambios desde tu branch para que otras personas los revisen antes de incorporarlos a tu documentación en producción. Esto ayuda a garantizar que tus cambios sean correctos y le da a tu equipo la oportunidad de colaborar en el contenido.
...
<Steps>
  <Step title="Guarda tu trabajo">
    Selecciona **Save Changes** para guardar todos los cambios en tu branch.
  </Step>

  <Step title="Crea el pull request">
    Selecciona **Publish Pull Request** desde la barra de herramientas del editor.
  </Step>

  <Step title="Agrega un título y una descripción">
    Escribe un título claro y una descripción que expliquen:
...
3. **Hacer cambios adicionales**: Realiza cambios adicionales en el editor visual. Al guardar, el editor los envía al pull request.
4. **Aprobar**: Aprueba el pull request cuando estés conforme con los cambios.
5. **Fusionar**: Fusiona el pull request cuando estés listo para desplegar los cambios a producción.

<div id="keyboard-shortcuts">
  ## Atajos de teclado
</div>

El editor visual admite todos los atajos de teclado comunes, como copiar, pegar, deshacer y seleccionar todo, además de los siguientes:
...
Encuentra soluciones a problemas comunes que podrías enfrentar al usar el editor visual.
...
<AccordionGroup>
  <Accordion title="Los cambios no aparecen después de publicar">
    ...
    **Soluciones:**
    ...
    1. Verifica el estado de la implementación en tu dashboard.
  ...
  <Accordion title="Errores de permisos al publicar">
    ...
    * Problemas de Authentication con tu proveedor de Git
    ...
    **Soluciones:**
    ...
    3. Revisa la documentación de [Editor Permissions](/es/dashboard/permissions).
  </Accordion>
...
* Aprende las prácticas recomendadas para colaborar con [branches](/es/guides/branches)