...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personaliza la apariencia de tu documentación<br /><br />Configura [theme](es/settings#param-theme) en docs.json usando uno de los siguientes temas.</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="Tema de documentación clásico con diseños probados y una navegación familiar." href="https://mint.mintlify.app" />
    ...
    <ThemeCard title="Willow" value="willow" description="Elementos esenciales depurados para una documentación sin distracciones." href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="Estética de terminal retro con tipografías monoespaciadas para ese estilo hacker de los 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Organización basada en cards combinada con un diseño minimalista para una navegación intuitiva." href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="Documentación moderna diseñada para navegación compleja y components personalizados." href="https://aspen.mintlify.app" />
  </div>
</div>
